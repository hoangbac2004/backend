...
oracle::occi::Environment* g_obj_env = oracle::occi::Environment::createEnvironment(oracle::occi::Environment::OBJECT);
oracle::occi::Connection* g_default_conn = g_obj_env->createConnection("system", "0", "localhost:1521/oracle");
